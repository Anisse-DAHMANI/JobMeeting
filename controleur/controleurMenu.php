   ...
   public function afficherMenu($pos) {
    if ($pos == 1) {
      ...
      if ($_SESSION['type_connexion'] == "responsable") {
        $this->vue->afficherPlanningResponsable();
      }
      //
    }
    if ($pos == 2) {
      ...
      //PROJET
      if ($_SESSION['type_connexion'] == "responsable") {
        $this->vue->afficherComptesResponsable();
      }
      //
    }
    if ($pos == 3) {
      ...
      //PROJET
      if($_SESSION['type_connexion'] == "responsable"){
        $tabFormations = $this->dao->getNbCreneauxParFormationResponsable($_SESSION['idUser']);
        $tabFormationsNonChoisies = $this->dao->getAllFormationsNonChoisies();
        $listeDepartements = $this->dao->getListeDepartements();
        $this->vue->afficherListeFormationsResponsable($tabFormations, $listeDepartements);
      }
      //
    ...
    if ($pos == 4) {
      ...
      //PROJET
      if ($_SESSION['type_connexion'] == "responsable") {
        $this->vue->afficherAutresResponsable();
      }
      //
    }
    if ($pos == 5){
