...
class PDF extends FPDF{
    ...
    function tableau($header,$ent,$indexPause,$w){
        $dao = new Dao();
...
foreach($AllEntreprises as $ent){
    ...
    $monTexte = 'Planning de '.iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE', str_replace("_", " ", $ent->getNomEnt()));
    $pdf->SetXY(120,60);
    $pdf->Cell($largeurDeCellule, 50,$monTexte, $border, $alignement);
    $pdf->SetXY(10,90);
    $pdf->tableau($header, $ent,$indexPause,$w);
}

$pdf->Output('I','planning_entreprises.pdf');
