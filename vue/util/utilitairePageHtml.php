...
class UtilitairePageHtml{
  ...
  */
  private function itemsBandeauApresConnexion(){
	...
	//PROJET
    elseif($_SESSION['type_connexion'] == 'responsable'){
      $menu ='<div id="menu" class="topmenu">
      <label for="afficher_menu" class="afficher_menu">Afficher le menu</label>
      <input type="checkbox" id="afficher_menu" role="button">

      <ul id = "onglets">
      <div class="onglet_resp">
      <li id = "onglet1">
      <a href="index.php?choix=ok&menu=1">Planning</a>
      </li>
      </div>
      ...
      <div class = "onglet_resp">
      <li id = "onglet4">
      <a href="index.php?choix=ok&menu=4">Autres</a>
      </li>
      </div>
      <div class="onglet_resp">
      <li id = "ongletDeconnexion">
  ...
  */
  public function genereEnteteHtml(){
    ...
    $entete.='<link href="https://code.jquery.com/ui/1.12.1/themes/smoothness/jquery-ui.css" rel="Stylesheet"></link>';
    $entete.='<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js" ></script>';
    $entete.="</head>\n";
    $entete.='<body>'."\n".'
    <div id="haut_page">
